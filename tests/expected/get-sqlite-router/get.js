...
function getFirstFiveBodyRowsByNameDesc() {
  return [
    whiteRascal,
    {
      ...
      brewery_id: 3,
      description:
        'The collaboration of two Craft companies both led by women, New Glarus Brewing and Weyermann Malting, is unique. You hold the result “Two Women” a Classic Country Lager.',
      name: 'Two Women',
    },
    thaiStyleWhiteIPA,
    {
...
function getCommonBeer() {
  return {
    averyIPA: {
      ...
      brewery_id: 1,
      description:
        'Avery IPA features a citrusy, floral bouquet and a rich, malty finish.',
      name: 'Avery IPA',
    },
    banjoCat: {
      id: 14,
    ...
    serendipity: {
      ...
      brewery_id: 3,
      description:
        'You hold the happy accident of Wisconsin’s favorite fruit aged in oak with an almost magical wild fermentation.',
      name: 'Serendipity',
    },
    thaiStyleWhiteIPA: {
      id: 5,
