...
const appendMidParsed = common.appendMidParsed
  , attachError = common.attachError
  , getInvalidOrderElements = common.getInvalidOrderElements
  ...
  , quoteNotAdjacentToAnother = common.quoteNotAdjacentToAnother
  , removeLeading = common.removeLeading
  , startsWith = utils.startsWith
  , takeWhileWithIndexAndArr = utils.takeWhileWithIndexAndArr
  ;
